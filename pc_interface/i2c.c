...
void i2cInit(void)
{
	...
	sbi(SDA_PORT, SDA_PIN);	// i2c SCL on ATmega163,323,16,32,etc
	sbi(SCL_PORT, SCL_PIN);	// i2c SDA on ATmega163,323,16,32,etc
...
void i2cFlushBuffers(void)
{
	for(u08 i = 0; i < I2cSendDataLength; i++) I2cSendData[i] = 0;
	I2cSendDataIndex = 0;
	for(u08 i = 0; i < I2cReceiveDataLength; i++) I2cReceiveData[i] = 0;
	I2cReceiveDataIndex = 0;
}
