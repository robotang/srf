...
void i2cswSend(BYTE device, BYTE sub, BYTE length, BYTE *data);

// receive I2C data from <device> register <sub>
void i2cswReceive(BYTE device, BYTE sub, BYTE length, BYTE *data);

void i2cswSendNS(BYTE device, BYTE length, BYTE *data);
void i2cswReceiveNS(BYTE device, BYTE length, BYTE *data);
